...
class TestXMLDocument{
    ...
    fun addXMLEntity(){
        ...
        documento.add(xmlEntityToAdd = entidade)
        ...
        documento1.add(xmlEntityToAdd = entidade)
    ...
    fun removeXMLEntity(){
        ...
        assertEquals(entidade,documento.getEntityChild)
        assertEquals(documento,entidade.getParent)
        documento.remove(xmlEntityToRemove = entidade)
        assertEquals(null,documento.getEntityChild)
    ...
    fun prettyPrint(){
        ...
        entidade1.add(xmlAttributeToAdd = atributo0)
        ...
        entidade5.add(xmlAttributeToAdd = atributo1)
    ...
    fun replaceXMLAttributeNameGlobally(){
        ...
        entidade2.add(xmlAttributeNameToAdd = "atributo3", xmlAttributeValueToAdd = "valor3")
    ...
    fun removeXMLAttributeGlobally(){
        ...
        assertEquals(entidade3.getAttributes[0].getValue,"valor1")
        entidade2.add(xmlAttributeNameToAdd = "atributo3", xmlAttributeValueToAdd = "valor3")
        entidade3.add(xmlAttributeNameToAdd = "atributo0", xmlAttributeValueToAdd = "valor0")
